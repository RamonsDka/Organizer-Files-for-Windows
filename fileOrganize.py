...
docs_formats  = ["ait","docx","doc","pdf","xlsx","pptx","txt","pptm","exc","dochtlm","diz","dic","log","rtf","wtx","pot","pps","ppt","dot","svs","xlshtml","docm","csv"]
...
while True:
	...
	for file in files:
		if os.path.isfile(file) and file != "fileOrganize.py" and file != "fileOrganize.bat" and file != "fileOrganize.vbs" and file != "ejecutar.bat":
